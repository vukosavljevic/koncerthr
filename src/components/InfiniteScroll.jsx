    ...
    return (
      <div className="logos" id="logo">
        <div className="logos-slide">
          ...
          <img src={taf} alt={`Logo ${1}`} key={1} target="_blank"/>
          </a>
          <a href="https://www.rcf.it/en/home">
          <img src={rcf} alt={`Logo ${2}`} key={2} target="_blank"/>
          </a>
          <a href="https://www.shure.com/en-EU">
          <img src={shure} alt={`Logo ${3}`} key={3} target="_blank"/>
          </a>
          <a href="https://www.robe.cz/">
          <img src={robe} alt={`Logo ${5}`} key={5} target="_blank"/>
          </a>
          <a href="https://www.fos-lighting.eu/">
          <img src={fos} alt={`Logo ${6}`} key={6} target="_blank"/>
          </a>
          <a href="https://www.kv2audio.com/">
          <img src={kv} alt={`Logo ${7}`} key={7} target="_blank"/>
          </a>
          <a href="hhttps://www.midasconsoles.com/">
          <img src={midas} alt={`Logo ${8}`} key={8} target="_blank"/>
          </a>
          <a href="https://www.shure.com/en-EU">
          <img src={shure} alt={`Logo ${3}`} key={3} target="_blank"/>
          </a>
